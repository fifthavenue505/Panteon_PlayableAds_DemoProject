...
namespace ToonyColorsPro.Runtime
{
	public static class TCP2_RuntimeUtils
	{
		...
		{
			string baseName = ((material.shader != null && material.shader.name.ToLower().Contains("mobile")) ? "Mobile" : "Desktop");
			...
			string basePath = "Toony Colors Pro 2/";
			if (newShader != baseName)
			{
				basePath = "Hidden/Toony Colors Pro 2/Variants/";
			}
			return Shader.Find(basePath + newShader);
		}
	}
}
