...
namespace EpicToonFX
{
	public class ETFXButtonScript : MonoBehaviour
	{
		...
		public bool overButton()
		{
			...
			if (button1.Contains(new Vector2(Input.mousePosition.x, (float)Screen.height - Input.mousePosition.y)) || button2.Contains(new Vector2(Input.mousePosition.x, (float)Screen.height - Input.mousePosition.y)))
			{
				return true;
			}
			return false;
